<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'SMARTBOX | LOCKER STATUS : '.strtoupper($lockerStatus).' ';
    ...
    <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <title>SMARTBOX | LOCKER STATUS</title>
      </head>
      <body>
      ...
      <head>
        ...
        <title>SMARTBOX | LOCKER STATUS | '.strtoupper($lockerStatus).'</title>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>LOCKER STATUS : '.$lockerStatus.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
