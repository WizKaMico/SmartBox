<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'SMARTBOX | EMAIL VERIFICATION : '.strtoupper($email).' ';
    ...
    <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <title>SMARTBOX | EMAIL VERIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>4-DIGIT CODE : '.$code.'</b></h3></p>
                            <p><a href="http://localhost/smart/views/admin/verify/?code='.$code.'"><h3 style="text-align:center;"><b>CLICK LINK TO VERIFY ACCOUNT</b></h3></a></p>
                          </td>
                        </tr>
                      </table>
                    </td>
