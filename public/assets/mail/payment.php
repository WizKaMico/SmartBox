<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'SMARTBOX | PAYMENT STATUS : '.strtoupper($status).' ';
    ...
    <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <title>SMARTBOX | PAYMENT STATUS</title>
      </head>
      <body>
      ...
      <head>
        ...
        <title>SMARTBOX | PAYMENT STATUS | '.strtoupper($status).'</title>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>REFERENCE : '.$ref.'</b></h3></p>
                          </td>
                        </tr>
                      </table>
                    </td>
