<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'SMARTBOX | ACCOUNT CREDENTIAL : '.strtoupper($email).' ';
    ...
    <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <title>SMARTBOX | ACCOUNT CREDENTIAL</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>4-DIGIT CODE : '.$coda.'</b></h3></p>
                            <p><h3 style="text-align:center;"><b>PINCODE : '.$pincode.'</b></h3></p><br/>
                            <p><b>NOTE : When you scan the QR Code you need to enter this code for you to login </b></p> <br>
                          </td>
                        </tr>
                      </table>
                    </td>
