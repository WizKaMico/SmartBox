<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = 'SMARTBOX | EMAIL VERIFICATION CONFIRMATION : '.strtoupper($email).' ';
    ...
    <!DOCTYPE html>
      ...
      <head>
        <meta charset="UTF-8">
        <title>SMARTBOX | EMAIL VERIFICATION CONFIRMATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <p><h3 style="text-align:center;"><b>4-DIGIT CODE : '.$code.'</b></h3></p><br/>
                            <p>Has been verified succesfully<br>
                          </td>
                        </tr>
                      </table>
                    </td>
