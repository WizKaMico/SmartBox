<div class="container d-flex flex-column flex-grow-1 overflow-auto bg-white p-4" style="max-width: 480px; color:black;">
        <div class="d-flex justify-content-between mb-4">
            <a href="./logout.php" class="text-secondary fs-4"><i class="bi bi-arrow-left"></i></a>
            <div></div>
        </div>
        <form method="POST" action="?view=TERMS&action=TERMS" class="px-2">
            ...
            <div>
                ...
                <div >
                    ...
                    <p><b>Unclaimed Belongings and Retrieval Fees</b><br>
                        If you fail to retrieve your belongings by the end of the rental period and the 24-hour grace period, your items will be placed in our lost and found. You may still retrieve your belongings, but a retrieval fee will apply if the grace period has passed. The fee schedule is as follows:<br>

                            • 1st Offense: Retrieval fee of P100 will apply.<br>
                            • 2nd Offense: Retrieval fee of P100 will apply, plus a penalty of P50.<br>
                            • 3rd Offense: Retrieval fee of P200 will apply, and you will be permanently banned from using our service.</p>
                            
                    <p><b>Banning Policy</b><br>
                    After the third offense of failing to retrieve your belongings within the designated time, you will be permanently banned from renting lockers with us. All rental privileges will be revoked, and you will not be allowed to use our service again.</p>
            ...
            <div class="d-flex position-fixed bottom-0 start-50 translate-middle-x bg-white px-4 py-3 w-100" style="max-width: 480px;">
                <button class="btn btn-light border fs-5 w-100" name="un-signed">&#x10102; Decline</button>
                <button class="btn btn-dark fs-5 ms-3 w-100" name="signed">&#x1F5F8; Accept</button>
            </div>
        </form>